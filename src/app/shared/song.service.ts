...
export class SongService {
  ...
  addSong(song: Song): Observable<any> {
    return this.http.post<Song>('http://192.168.1.108:3000/api/create-song', song, this.httpOptions)
      .pipe(
  ...
  getSong(id): Observable<Song[]> {
    return this.http.get<Song[]>('http://192.168.1.108:3000/api/get-song/' + id)
      .pipe(
  ...
  getSongList(): Observable<Song[]> {
    return this.http.get<Song[]>('http://192.168.1.108:3000/api')
      .pipe(
  ...
  updateSong(id, song: Song): Observable<any> {
    return this.http.put('http://192.168.1.108:3000/api/update-song/' + id, song, this.httpOptions)
      .pipe(
  ...
  deleteSong(id): Observable<Song[]> {
    return this.http.delete<Song[]>('http://192.168.1.108:3000/api/delete-song/' + id, this.httpOptions)
      .pipe(
